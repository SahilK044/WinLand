    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding: '0 8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <Share2 size={13} color="#0a84ff" />
          <span style={{ fontSize: 12, fontWeight: 700 }}>AirDrop</span>
        </div>
        <span style={{ fontSize: 11, color: '#0a84ff', fontWeight: 700 }}>{progress}%</span>
      </div>
    );
  }
    ...
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <div style={{ margin: '12px 0' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, fontWeight: 700, marginBottom: 6 }}>
          ...
          <span style={{ color: '#0a84ff' }}>{progress}%</span>
        </div>
        <div className="progress-track" style={{ height: 6 }}>
          <div
            ...
            style={{
              width: `${progress}%`,
              background: isDone ? '#30d158' : 'linear-gradient(90deg, #0a84ff, #0a84ff)',
            }}
          />
        </div>
      </div>
